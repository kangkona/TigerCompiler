...
public class CommandLine
{
  ...
  public CommandLine()
  {
    this.args = new util.Flist<Arg<Object>>().addAll(new Arg<Object>("codegen",
        "{bytecode|C|dalvik|x86|Go}", "which code generator to use", Kind.String,
        new F<Object>() {
          @Override
          public void f(Object ss)
          {
            ...
            if (s.equals("bytecode")) {
              ...
              control.Control.codegen = control.Control.Codegen_Kind_t.Go;
            }
            else if (s.equals("XML")){
                control.Control.codegen = control.Control.Codegen_Kind_t.XML;
              }
            else {
        ...
        "whether or not to test the Tiger compiler on Fac.java/Fac", Kind.Empty, new F<Object>() {
          @Override
          public void f(Object s)
          {
        ...
        }),new Arg<Object>("testSum", null,
        "whether or not to test the Tiger compiler on Fac.java/Sum", Kind.Empty, new F<Object>() {
          @Override
          public void f(Object s)
          {
            Control.testSum = true;
            return;
          }
