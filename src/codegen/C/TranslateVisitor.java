...
public class TranslateVisitor implements ast.Visitor
{
  ...
  private codegen.C.stm.Block block;
...
//  private java.util.LinkedList<String> blockEnv; // id declear in block
//  private java.util.LinkedList<String> methodEnv; //id declear in method
...
//    this.blockEnv = new java.util.LinkedList<String>();
//    this.methodEnv = new java.util.LinkedList<String>();
  ...
  public void visit(ast.exp.Call e)
  {
    ...
    this.tmpVars.add(new codegen.C.dec.Dec(new codegen.C.type.Class(e.type),
        ""+newid));
//    System.out.println("Call:"+e.type);
  ...
  {  
	 ...
	 for (int i=preBlock;i<this.tmpVars.size();i++) {
		 //codegen.C.dec.T dec = this.tmpVars.remove(i);
		 locals.add(this.tmpVars.get(i));
	 }
	 
	 this.stm = new codegen.C.stm.Block(locals,newStm);
	 this.block = (codegen.C.stm.Block)this.stm;
	 return;
  }
  ...
  {
	this.type = new codegen.C.type.Int(); //in C,boolean is int
	return;
  }
  ...
  public void visit(ast.mainClass.MainClass c)
  {
    ...
    //codegen.C.mainMethod.T mthd = new codegen.C.mainMethod.MainMethod(
      //  this.tmpVars, this.block);
    codegen.C.mainMethod.T mthd = new codegen.C.mainMethod.MainMethod(this.block);
